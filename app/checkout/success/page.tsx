...
async function getTransactionData(transactionId: string) {
	const transactionData = await normieTechClient.GET(
...
export default async function PaymentSuccessPage({
	...
	if (
		...
		return <h1>Error some data not defined</h1>;
	}
				...
				<Card className="overflow-hidden rounded-lg border-0 bg-white shadow-lg">
					<div className="flex flex-col items-center p-6 text-center">
						...
						<p className="mb-6 text-slate-600">
							Thank you for supporting this important cause. Your contribution
